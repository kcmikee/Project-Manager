...
@section('content')
        <div class="container">
          ...
          <h3>{{ $task->name }}</h3>
          <hr class="my-3">
          <h4>It'll take {{ $task->days }} days to complete this task</h4>
      ...
      @if($task->user_id == Auth::user()->id)
                <li>
                  ...
                  <form id="delete-form" action=" {{ route('tasks.destroy', [$task->id])}} " method="post" style="dispalay:none;">
    ...
    @endif
                ...
                <li><a href="/tasks/create/{{ $task->id }}"><i class="fa fa-briefcase"></i>Add New Task</a></li>
